...
namespace ImGui
{
    ...
    IMGUI_API bool          MyInputFloat3(const char* label, const char* label1, const char* label2, const char* label3, ImColor color1, ImColor color2, ImColor color3, float v[3], const char* format = "%.3f", ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputFloat4(const char* label, float v[4], const char* format = "%.3f", ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          MyInputFloat4(const char* label, const char* label1, const char* label2, const char* label3, const char* label4, ImColor color1, ImColor color2, ImColor color3, ImColor color4, float v[4], const char* format = "%.3f", ImGuiInputTextFlags flags = 0);
    ...
    IMGUI_API bool          MyInputScalarN3(const char* label, const char* label1, const char* label2, const char* label3, ImColor color1, ImColor color2, ImColor color3, ImGuiDataType data_type, void* p_data, int components, const void* p_step = NULL, const void* p_step_fast = NULL, const char* format = NULL, ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          MyInputScalarN4(const char* label, const char* label1, const char* label2, const char* label3, const char* label4, ImColor color1, ImColor color2, ImColor color3, ImColor color4, ImGuiDataType data_type, void* p_data, int components, const void* p_step = NULL, const void* p_step_fast = NULL, const char* format = NULL, ImGuiInputTextFlags flags = 0);
